                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white ">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30 shabnam">حساب کاربری نداری? <a href="page-register.html">یکی
                                                    بساز</a></p>
                                        </div>
                                            ...
                                            <div class="tab-pane" id="dashboard" role="tabpanel"
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h4 class="mb-0 shabnam">شماره همراه خود را وارد کنید</h4>
                                                            <form method="post">
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-heading btn-block shabnam" style="width: 100%" name="login">ارسال پیامک</button>    
                                                                </div>
                                                            </form>
                                            ...
                                            <div class="tab-pane active" id="userPassword" role="tabpanel"
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group" dir="rtl">
                                                        <button type="submit"
                                                            class="btn btn-heading btn-block hover-up shabnam"
