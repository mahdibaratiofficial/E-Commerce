<main class="main">
                            ...
                            @foreach ($_GET as $key => $query)
                                <li class="hover-up">
                                    <a href="blog-category-grid.html"><i
                                            class="fi-rs-cross mr-10"></i>{{ $key . ':' . $query }}</a>
                                </li>
                            @endforeach
                        </ul> --}}
                    </div>
    ...
    <div class="container mb-30">
        <div class="row flex-row-reverse">
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>ما <strong class="text-brand">{{ count($products) }}</strong> محصول برای شما پیدا کردیم!</p>
                    </div>
                    <div class="sort-by-product-area">
                        <div class="sort-by-cover mr-10">
                            <div class="sort-by-product-wrap">
                                ...
                                <div class="sort-by-dropdown-wrap">
                                    <span> 15 <i class="fi-rs-angle-small-down"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="sort-by-cover">
                            ...
                            <div class="sort-by-dropdown">
                                <ul>
                                    <li><a wire:click="$set('sort','Featured')" class="active">معمولی</a></li>
                                    <li><a wire:click="$set('sort','LTH')">ارزان ترین</a></li>
                                    <li><a wire:click="$set('sort','HTL')">گرانترین</a></li>
                                    <li><a wire:click="$set('sort','dateNew')">جدید ترین</a></li>
                                    <li><a wire:click="$set('sort','dateOld')">قدیمی ترین</a></li>
                                    <li><a wire:click="$set('sort','')">پرطرفدار ترین</a></li>
                                    <li><a wire:click="$set('sort','')">پر بازدید ترین</a></li>
                                    <li><a wire:click="$set('sort','')">بیشترین فروش </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row product-grid" wire:init="loadProducts">
                    @foreach ($products as $product)
                        <!--end product card-->
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="" style="padding:10px;width:100%;height:200px !important;overflow: hidden">
                                    <a href="{{ '/product/' . $product->slug }}">
                                        <img loading="lazy" class="default-img"
                                            src="{{ $product->images[0]->url ?? '/images/empty.jpg' }}" alt=""
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a
                                            wire:click="$set('category','{{ $product->categories[0]->title ?? '' }}')">{{ $product->categories[0]->title ?? 'بدون دسته بندی' }}</a>
                                    </div>
                                    ...
                                    <div>
                                        <span class="font-small text-muted">توسط : <a
                                                href="vendor-details-1.html">{{ $product->vendor->vendor_name ?? 'خالی' }}</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>
                                                {{ $product->price }}
                                                <span class="">
                                                    <svg class="mr-1 text-light" width="16" height="17"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href="shop-product-right.html">
                                            <img loading="lazy" src="/assets/main/imgs/banner/banner-5.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href="shop-product-right.html">
                                            <img loading="lazy" src="/assets/main/imgs/banner/banner-6.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href="shop-product-right.html">
                                            <img loading="lazy" src="/assets/main/imgs/banner/banner-7.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href="shop-product-right.html">
                                            <img loading="lazy" src="/assets/main/imgs/banner/banner-8.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="col-lg-1-5 primary-sidebar" wire:ignore>
                <div class="sidebar-widget widget-category-2 mb-30">
                    <h5 class="section-title mb-30">دسته بندی</h5>
                    <ul wire:init="loadProducts">
                        @foreach ($this->getCategories() as $category)
                            <li>
                                <a wire:click="$set('category','{{ $category->title }}')"> <img loading="lazy"
                                        src="{{ $category->images[0] ?? '/images/empty.jpg' }}"
                                        alt="" />{{ $category->title }}</a><span
                ...
                <div class="sidebar-widget range mb-30">
                    <h5 class="section-title  mb-30">فیلتر بر اساس قیمت</h5>
                    <div class="price-filter">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-10">
                                <input class="form-control" placeholder="حداقل" wire:model.lazy="minPrice">
                            </div>

                            <div class="col-2">
                                <span class="">
                                    <svg class="mr-1 text-light" width="19" height="20" viewBox="0 0 9 10"
                            ...
                            <div class="col-10">
                                <input class="form-control" placeholder="حداکثر" wire:model.lazy="maxPrice">
                            </div>
                    ...
                    <div class="list-group">
                        <div class="list-group-item mb-10 mt-10">
                            <label class="fw-900">فیلتر بر اساس دسته بندی</label>
                                ...
                                @foreach ($this->getCategories() as $category)
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="{{ $category->id }}" data-bs-parent="#accordionExample">
                ...
                <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10" wire:ignore>
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img src="/assets/main/imgs/shop/thumbnail-3.jpg" alt="#" loading="lazy" />
                        </div>
                        <div class="content pt-10">
                            <h5><a href="http://wp.alithemes.com/html/nest/demo-rtl/shop-product-detail.html">Chen
                                    Cardigan</a></h5>
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img loading="lazy" src="/assets/main/imgs/shop/thumbnail-4.jpg" alt="#" />
                        </div>
                        <div class="content pt-10">
                            <h6><a href="http://wp.alithemes.com/html/nest/demo-rtl/shop-product-detail.html">Chen
                                    Sweater</a></h6>
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img loading="lazy" src="/assets/main/imgs/shop/thumbnail-5.jpg" alt="#" />
                        </div>
                        <div class="content pt-10">
                            <h6><a href="http://wp.alithemes.com/html/nest/demo-rtl/shop-product-detail.html">Colorful
                                    Jacket</a></h6>
                ...
                <div class="banner-img wow fadeIn mb-lg-0 animated d-lg-block d-none" wire:ignore>
                    <img loading="lazy" src="/assets/main/imgs/banner/banner-11.png" alt="" />
