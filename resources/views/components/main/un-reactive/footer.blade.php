            ...
            <div class="container pt-15 pb-20">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="../../../cdn-cgi/l/email-protection.htm" class="__cf_email__" data-cfemail="cbb8aaa7ae8b85aeb8bfe5a8a4a6">[email&#160;protected]</a></span></li>
                ...
                <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="download-app">
                        <a href="index.html#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="assets/imgs/theme/app-store.jpg" alt="" /></a>
                        <a href="index.html#" class="hover-up mb-sm-2"><img src="assets/imgs/theme/google-play.jpg" alt="" /></a>
                    </div>
