<div class="header-nav d-none d-lg-flex">
    <div class="main-categori-wrap d-none d-lg-block">
        <a class="categories-button-active" href="index.html#">
            <span class="fi-rs-apps"></span> همه دسته بندی ها
    ...
    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
        <nav>
            <ul>
                ...
                <li>
                    <a href="page-about.html">درباره ما</a>
                </li>
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="index.html#">Single Product <i class="fi-rs-angle-right"></i></a>
                            <ul class="level-menu">
                        ...
                        <li>
                            <a href="index.html#">Shop Invoice<i class="fi-rs-angle-right"></i></a>
                            <ul class="level-menu">
                ...
                <li>
                    <a href="index.html#">Vendors <i class="fi-rs-angle-down"></i></a>
                    <ul class="sub-menu">
                ...
                <li class="position-static">
                    <a href="index.html#">Mega menu <i class="fi-rs-angle-down"></i></a>
                    <ul class="mega-menu">
                        <li class="sub-mega-menu sub-mega-menu-width-22">
                            <a class="menu-title" href="index.html#">Fruit & Vegetables</a>
                            <ul>
                        ...
                        <li class="sub-mega-menu sub-mega-menu-width-22">
                            <a class="menu-title" href="index.html#">Breakfast & Dairy</a>
                            <ul>
                        ...
                        <li class="sub-mega-menu sub-mega-menu-width-22">
                            <a class="menu-title" href="index.html#">Meat & Seafood</a>
                            <ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="index.html#">Single Post <i class="fi-rs-angle-right"></i></a>
                ...
                <li>
                    <a href="index.html#">Pages <i class="fi-rs-angle-down"></i></a>
                    <ul class="sub-menu">
