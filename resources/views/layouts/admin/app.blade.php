...
<head>
  ...
  <link rel="stylesheet" href="css/vertical-layout-light/rtl.css" />
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas sidebar-fixed" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#theme" aria-expanded="false"
              aria-controls="theme">
              <i class="icon-columns menu-icon 
              mdi mdi-brush "></i>
              <span class="menu-title">قالب وبسایت</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">عناصر</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/dropdowns.html">منو بازشونده</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false"
              ...
              <span class="menu-title">عناصر فرم</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">نمودار</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="pages/tables/basic-table.html">جداول پایه</a>
                </li>
              </ul>
            </div>
          </li>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold" id="test">خوش آمدی علیرضا</h3>
