...
<body style="font-family:irs !important">
        ...
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-top">
                <div class="mobile-header-logo">
                    <a href="index.html"><img src="/assets/main/imgs/theme/logo.svg" alt="logo"
                            loading="lazy" /></a>
                </div>
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon mb-50">
                    ...
                    <a href="index.html#"><img loading="lazy"
                            src="/assets/main/imgs/theme/icons/icon-facebook-white.svg" alt="" /></a>
                    <a href="index.html#"><img loading="lazy"
                            src="/assets/main/imgs/theme/icons/icon-twitter-white.svg" alt="" /></a>
                    <a href="index.html#"><img loading="lazy"
                            src="/assets/main/imgs/theme/icons/icon-instagram-white.svg" alt="" /></a>
                    <a href="index.html#"><img loading="lazy"
                            src="/assets/main/imgs/theme/icons/icon-pinterest-white.svg" alt="" /></a>
                    <a href="index.html#"><img loading="lazy"
                            src="/assets/main/imgs/theme/icons/icon-youtube-white.svg" alt="" /></a>
                </div>
