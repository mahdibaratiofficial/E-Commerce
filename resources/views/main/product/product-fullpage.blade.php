                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="product-detail-rating">
                                    <div class="product-rate-cover text-end">
                                        ...
                                        <span class="font-small ml-5 text-muted shabnam"> ({{ rand(3,100) }} نظر)</span>
                                    </div>
                                </div>
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        ...
                                        <span>
                                            <span class="save-price font-md color3 ml-15 shabnam">{{ rand(1,100) }}% تخفیف</span>
                                            <span class="old-price font-md ml-15">{{ $product->price-rand(1,100) }}</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="detail-extralink mb-50">
                                    <div class="detail-qty border radius">
                                        <a href="shop-product-full.html#" class="qty-down"><i class="fi-rs-angle-small-down"></i></a>
                                        <span class="qty-val">1</span>
                                        <a href="shop-product-full.html#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                    </div>
                                    <div class="product-extra-link2">
                                        <button type="submit" class="button button-add-to-cart shabnam"><i class="fi-rs-shopping-cart"></i>اضافه به سبد خرید</button>
                                ...
                                <div class="font-xs">
                                    ...
                                    <ul class="float-start">
                                        ...
                                        <li class="mb-5">Tags: <a href="shop-product-full.html#" rel="tag">Snack</a>, <a href="shop-product-full.html#" rel="tag">Organic</a>, <a href="shop-product-full.html#" rel="tag">Brown</a></li>
                    ...
                    <div class="product-info">
                        <div class="tab-style3">
                            <ul class="nav nav-tabs text-uppercase">
                                <li class="nav-item">
                                    <a class="nav-link active" id="Description-tab" data-bs-toggle="tab" href="shop-product-full.html#Description">Description</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab" href="shop-product-full.html#Additional-info">Additional info</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Vendor-info-tab" data-bs-toggle="tab" href="shop-product-full.html#Vendor-info">Vendor</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="shop-product-full.html#Reviews">Reviews (3)</a>
                                </li>
                            </ul>
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex mb-30">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                ...
                                                                <a href="shop-product-full.html#" class="font-heading text-brand">Sienna</a>
                                                            </div>
                                                            <div class="desc">
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex mb-30 ml-30">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                ...
                                                                <a href="shop-product-full.html#" class="font-heading text-brand">Brenna</a>
                                                            </div>
                                                            <div class="desc">
                                                                <div class="d-flex justify-content-between mb-10">
                                                                    <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                ...
                                                                <a href="shop-product-full.html#" class="font-heading text-brand">Gemma</a>
                                                            </div>
                                                            <div class="desc">
                                                                <div class="d-flex justify-content-between mb-10">
                                                                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="comment-form">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 col-md-12">
                                                <form class="form-contact comment_form" action="shop-product-full.html#" id="commentForm">
                                                    <div class="row">
                                                        <div class="col-12">
